...
class TestEmployee:
    ...
    def test_get_reviews(self):
        ...
        Employee.create_table()
        employee1 = Employee.create("Raha", "Accountant", department)
        employee2 = Employee.create("Kai", "Senior Accountant", department)

        Review.create_table()
        review1 = Review.create(2020, "Good work ethic", employee1)
        review2 = Review.create(2021, "Great work ethic!", employee1)
        review3 = Review.create(2020, "Always late", employee2)
